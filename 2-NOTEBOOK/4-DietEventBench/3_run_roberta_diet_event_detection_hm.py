...
from nn.cgmencoder.modeling_cgmencoder import RobertaWithHMForSequenceClassification
...
model_name = 'roberta-with-hm-small'
# config = RobertaWithHMConfig(
#     vocab_size=len(tokenizer),
#     hm_vocab_size=len(hm_idx2tkn),
...
model_name = 'roberta-with-hm-large'
config = RobertaWithHMConfig(
    vocab_size=len(tokenizer),
    hm_vocab_size=len(hm_idx2tkn),
    num_labels=num_labels,
...
python 2-NOTEBOOK/4-DietEventBench/3_run_roberta_diet_event_detection_hm.py
'''
