...
# python 2-NOTEBOOK/4-DietEventBench/run_case_dietevent.py --cohort WellDoc2022CGM --n_cpus 1
# python 2-NOTEBOOK/4-DietEventBench/run_case_dietevent.py --cohort WellDoc2025ALS --n_cpus 1
# python 2-NOTEBOOK/4-DietEventBench/run_case_dietevent.py --cohort WellDoc2025CVS --n_cpus 1
# python 2-NOTEBOOK/4-DietEventBench/run_case_dietevent.py --cohort WellDoc2025LLY --n_cpus 1
...
########################################################
dataset_init_path = os.path.join(SPACE['DATA_SPLIT'], 'WellDoc_ds_case_dietevent_split.parquet')
dataset_init = pd.read_parquet(dataset_init_path)

dataset_init_name = 'DietEvent'
dataset_init_info = {
