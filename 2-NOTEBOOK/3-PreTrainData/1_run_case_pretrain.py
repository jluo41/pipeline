...
# python 2-NOTEBOOK/3-PreTrainData/run_case_pretrain.py --cohort WellDoc2022CGM --n_cpus 4
# python 2-NOTEBOOK/3-PreTrainData/run_case_pretrain.py --cohort WellDoc2025ALS --n_cpus 2
# python 2-NOTEBOOK/3-PreTrainData/run_case_pretrain.py --cohort WellDoc2025CVS --n_cpus 4
# python 2-NOTEBOOK/3-PreTrainData/run_case_pretrain.py --cohort WellDoc2025LLY --n_cpus 8
...
########################################################
dataset_init_path = os.path.join(SPACE['DATA_SPLIT'], 'WellDoc_ds_case_pretrain_split.parquet')
dataset_init = pd.read_parquet(dataset_init_path)

dataset_init_name = 'Pretrain'
dataset_init_info = {
